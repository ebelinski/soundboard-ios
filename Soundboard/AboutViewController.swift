...
class AboutViewController: UIViewController {
  ...
  private func setUpScrollViewContent() {
    ...
    informationPart1.text = "Soundboard for TYT was created by Eugene Belinski. It's available for iOS and Android! Please contact me if you find any bugs, want me to add a new sound, or if you have any comment or suggestion."
